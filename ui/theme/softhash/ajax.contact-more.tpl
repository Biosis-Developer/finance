...
<form class="form-horizontal">
    ...
    <div class="form-group"><label class="col-lg-2 control-label" for="instagram">{$_L['Instagram Profile']}</label>

        <div class="col-lg-10"><input type="text" id="instagram" name="instagram" value="{$d['instagram']}" class="form-control" autocomplete="off">
