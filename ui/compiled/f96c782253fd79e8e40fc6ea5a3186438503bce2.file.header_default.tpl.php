<?php /* Smarty version Smarty-3.1.13, created on 2015-12-04 19:03:17
         compiled from "ui\theme\softhash\sections\header_default.tpl" */ ?>
<?php /*%%SmartyHeaderCode:215525661adeaf0c857-61914002%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '215525661adeaf0c857-61914002',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_5661adeb901c71_85744028',
  'variables' => 
  array (
    '_title' => 0,
    'app_url' => 0,
...
<?php if ($_valid && !is_callable('content_5661adeb901c71_85744028')) {function content_5661adeb901c71_85744028($_smarty_tpl) {?><!DOCTYPE html>
...
contacts/list/"><?php echo $_smarty_tpl->tpl_vars['_L']->value['List Contacts'];?>
 ...
 $_from = $_smarty_tpl->tpl_vars['sub_menu']->value['crm']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
settings/api/"><?php echo $_smarty_tpl->tpl_vars['_L']->value['API Access'];?>
 ...
 $_from = $_smarty_tpl->tpl_vars['sub_menu']->value['settings']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
sysfrm/uploads/system/logo.png" alt="Logo">
                    <div class="navbar-header ">
                        <a class="navbar-minimalize minimalize-styl-2 btn laranja" style="color:#fff;" href="#"><i class="fa fa-dedent"></i> </a>
