...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; }
        ...
        #logo { text-align: right; float: right; position: relative; margin-top: 25px; border: 1px solid #fff; width: 340px; overflow: hidden; }
    ...
    <table width="100%">
        <tr>
            ...
            <td style="border: 0;  text-align: right" width="62%"><div id="logo">
                    <img src="sysfrm/uploads/system/logo.png" alt="logo" /> <br>
